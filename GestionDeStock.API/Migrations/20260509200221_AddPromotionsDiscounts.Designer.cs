...
namespace GestionDeStock.API.Migrations
{
    ...
    [Migration("20260509200221_AddPromotionsDiscounts")]
    partial class AddPromotionsDiscounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionDeStock.API.Models.ProductDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GestionDeStock.API.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GestionDeStock.API.Models.PromotionEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GestionDeStock.API.Models.ProductDiscount", b =>
                {
                    b.HasOne("GestionDeStock.API.Models.PromotionEvent", "Event")
                        .WithMany("Discounts")
